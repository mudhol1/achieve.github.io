    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('course', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='main_app.course')),
                ('session', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='main_app.session')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category', multiselectfield.db.fields.MultiSelectField(choices=[('Sports_', 'Sports'), ('Cultural', 'Cultural'), ('Academics', 'Academics')], max_length=26)),
